<x-layout>
<main class="m-5">
    <h1 style="text-align: center; margin-top: 20px">THÊM MỚI DANH BẠ ĐƠN VỊ</h1>
    ...
    <form name="addDepartmentForm" action="{{ route('department.store') }}" method="post" enctype="multipart/form-data" onsubmit="return validatePhoneNumber()">
        @csrf
        <div class="mb-3">
...
<script>
    function validatePhoneNumber() {
        var phoneNumber = document.forms["addDepartmentForm"]["phone"].value;
