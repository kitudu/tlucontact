<x-layout>
<main class="m-5">
    <h1 style="text-align: center; margin-bottom: 20px">CẬP NHẬT THÔNG TIN NHÂN VIÊN</h1>
    ...
    <form name="editEmployeeForm" action="{{ route('employee.update', $employee) }}" method="post" enctype="multipart/form-data" onsubmit="return validatePhoneNumber()">
        @csrf
        @method("PUT")
